...
while running:
    ...
    if enemy_x - bullet_size // 2 <= bullet_x <= enemy_x + enemy_size - bullet_size // 2 and enemy_y <= bullet_y <= enemy_y + enemy_size:
        # print(f"{enemy_x - bullet_size // 2} <= {bullet_x} <= {enemy_x + enemy_size - bullet_size // 2}")
