...
if __name__ == '__main__':
    ...
    while True:
        ...
        if user_command[0] == 'insert':
            my_list.insert(int(user_command[1]), int(user_command[2]))
        if user_command[0] == 'print':
            print(my_list)
        if user_command[0] == 'remove':
            my_list.remove(int(user_command[1]))
        if user_command[0] == 'append':
            my_list.append(int(user_command[1]))
        if user_command[0] == 'sort':
            my_list.sort()
        if user_command[0] == 'pop':
            my_list.pop()
        if user_command[0] == 'reverse':
            my_list.reverse()
        N -= 1
